...
<template>
    ...
    <section class="z-10 flex flex-col items-center justify-center gap-6 h-min">
        ...
        border-gray-925 rounded-4xl bg-gradient-to-tr from-black to-purple-950 max-[850px]:mt-0
         max-[850px]:rounded-none max-[850px]:flex-col max-[850px]:h-[834px] max-[960px]:w-screen z-10">
            ...
            max-[344px]:ml-2 max-[850px]:ml-4 max-[850px]:-mb-48 max-[850px]:-mt-24">
                <h1 class="mb-3 text-3xl font-bold">Quizzler</h1>
                
                <p class="text-base max-w-[358px] tracking-wider leading-relaxed">
                    Quiz com <strong>30 questões dinâmicas</strong>, onde apenas 10 são exibidas por rodada.
                    Cada questão possui 4 alternativas, e a cada atualização da página,
                    novas perguntas e alternativas <strong>são geradas aleatoriamente</strong>.
                    <strong>Português, inglês e espanhol</strong> disponível.
                </p>

                <div class="flex flex-row gap-6 max-[344px]:-ml-2">

                    <button class="flex flex-row items-center justify-center gap-4 mt-10">
                               
                        <a href="https://quiizzler.netlify.app/" target="_blank"
                        class="relative inline-flex items-center px-20 overflow-hidden transition rounded-full py-7 group bg-zinc-800 ">
                            ...
                            <div class="absolute inset-0 flex items-center [container-type:inline-size]">
                                ...
                                <span class="relative flex flex-row gap-1 mt-px ml-3 text-xl font-semibold text-center text-transparent transition-all duration-200 font-manrope bg-gradient-to-b from-white/25 to-white bg-clip-text">
                    ...
                    <button class="flex flex-row items-center justify-center gap-4 mt-10">       
                        <a href="https://github.com/Gabriel-augt/quizzler" target="_blank"
                        class="relative inline-flex items-center px-20 overflow-hidden transition rounded-full py-7 group bg-zinc-800 ">
                            <div class="absolute inset-0 flex items-center [container-type:inline-size]">
            ...
            <section class="flex flex-col items-center justify-center h-full gap-6 grow max-[850px]:-mt-12">
                <figure>
                    <img class="w-[368px] h-[192px] rounded-xl" src="/quizzler-print.png">
                </figure>
                
                <div class="flex flex-row gap-6 font-bold tracking-wider max-[850px]:mt-4">
                    
                    <div class="flex flex-col items-center">
                        <figure class="p-2 border rounded-xl border-gray-925 hover:bg-black-925">
                            <img class="w-6 h-6 rounded-md" src="/vue.svg">
                        </figure>
                        <p class="mt-1 text-xs">VueJS</p>
                    </div>
